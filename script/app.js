...
let burgersBtn = document.querySelectorAll('.wrapper__list-btn'),
    ...
    // checklistText = document.querySelector('.checklist--text')
...
function basket() {
    ...
    if(productArray.length) {
        ...
        const checklistTeks = document.createElement('span')
        checklistTeks.innerHTML = 'Корзина пуста'
         checklistTeks.classList.add('checklist--text')


        cartListItem.append(checklistTeks)
    }
